...
import net.playq.tk.postgres.implicits._
...
abstract class PostgresTestBase[F[+_, +_]: IO2: TagKK: DefaultModule2](implicit ev: TagK[F[Throwable, ?]]) extends TkTestBaseCtx[F, Ctx[F]] {
